...
FALLBACK_MSG_NO_INFO = "문의하신 내용에 대한 정보는 저희 공식 자료에 명시되어 있지 않아 정확한 안내가 어렵습니다. 관리사무소로 문의해 주시기 바랍니다."
...
def generate_ai_response_total_knowledge(user_message: str) -> str:
    ...
    당신은 '크리스찬메모리얼파크 AI 상담원'입니다. 당신의 단 하나의 임무는, 아래 제공되는 '[공식 지식 베이스]'의 내용에만 근거하여 사용자의 질문에 가장 정확하고 도움이 되는 답변을 제공하는 것입니다. 따뜻한 말투로 유가족의 마음을 헤아려주는 말투를 사용하세요.
